...
class Solution:
    """
    >>> Solution().countPairs(list2tree('[1,2,3,null,4]'), distance = 3)
    1

    >>> Solution().countPairs(list2tree(' [1,2,3,4,5,6,7]'), distance = 3)
    2

    >>> Solution().countPairs(list2tree('[7,1,4,6,null,5,3,null,null,null,null,null,2]'), distance = 3)
    1

    >>> Solution().countPairs(list2tree('[100]'), distance = 1)
    0

    >>> Solution().countPairs(list2tree('[1,1,1]'), distance = 2)
    1
