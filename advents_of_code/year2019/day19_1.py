...
for x in range(772, 750, -1):
    for y in range(1507, 1380, -1):
        ...
        c = 0
        for x1 in range(x, x + 101):
            if get_wall(x1, y) == '#':
                c += 1

        for y1 in range(y, y + 101):
            if get_wall(x, y1) == '#':
                c += 1
...
# print(get_wall(771, 1505))


# for b in range(800, 10000):
#     a, b, c, A, B, C = solve(C=90 * degree, b=b, A=59.689 * degree)
#
#     # print(b, a)
#
#     counter = 0
#     for z in range(b, b - 4000, -1):
#
#         if get_wall(z, int(a)) == '#':
#             counter += 1
#
#         if get_wall(z, int(a)) != '#' and counter:
#             break
#         if counter == 100:
#             break
#
#     print(f'Found line {b}, counter {counter}')
#
#     if counter >= 100:
#         counter = 0
#         for q in range(int(a), int(a) + 501):
#             if get_wall(z + 1, q) == '#':
#                 counter += 1
#             else:
#                 print(counter)
